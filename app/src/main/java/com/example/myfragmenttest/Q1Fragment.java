...
public class Q1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_q1, container, false);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(check2 == true && check1 == false && check3 == false && check4 == false){
        ...
        Button button2 = rootView.findViewById(R.id.Q2go);
